...
description: How Engram is meant to be used
---

# Intended Usage

Engram is persistent memory for AI coding agents. It saves decisions, discoveries, bug fixes, and context across sessions -- automatically.

## If You Installed via gentle-ai

**You're done.** Engram is already configured. Your AI agent saves and retrieves memories on its own.
